...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_200 = Integer(200); _sage_const_4 = Integer(4); _sage_const_2001 = Integer(2001); _sage_const_2002 = Integer(2002)
import random
import time
...
r=_sage_const_4 
for deg in range(_sage_const_2001 ,_sage_const_2002 ):
    with open('balanced_ab1','a') as f:
        print("For degree ",deg,file=f)
    i = (deg // _sage_const_2 ) - _sage_const_1 
    curve=[x**i*y**(deg-i), x**(deg-_sage_const_2 )*y**_sage_const_2  + x**_sage_const_2 *y**(deg-_sage_const_2 ), x**deg,x**(deg-_sage_const_1 )*y+x*y**(deg-_sage_const_1 ), y**(deg)]
    res=check_for_this_curve(curve)
    #print('hi', res)
    if res[_sage_const_0 ] == _sage_const_1 :
        with open('balanced_ab1','a') as f:
            #print(curve[0],file=f)
            for i in res[_sage_const_1 ][_sage_const_0 ]:
                print(i,file=f)
            print('\n',file=f)
    else:
       assert False
